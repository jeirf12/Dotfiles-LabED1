...
public class ArbolN_Ario<T> {
	...
	public void padreNodo(T dato) {
		if (this.buscarElemento(this.raiz, dato)) {
			...
			else System.out.println("No tiene padre porque es la raíz");
		}else System.out.println("El nodo no esta en el árbol");
	}
	...
	public void nivelNodo(T dato) {
		...
		if (this.buscarElemento(dato)) {
			...
			if (nivel > 0) System.out.println("El dato " + dato + " nivel " + nivel + " del árbol");
			else System.out.println("El dato " + dato + " nivel " + nivel + " del árbol es la raíz");
		}else System.out.println("El nodo no esta en el árbol");
	}
	...
	public void mostrarHermanos(T dato) {
		if (this.buscarElemento(raiz, dato)) {
			...
			}else System.out.println("El dato " + dato + " no tiene hermanos es la raíz");
		}else System.out.println("El nodo no esta en el árbol");
	}
